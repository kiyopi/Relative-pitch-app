...
| ファイル | 役割 | 主要関数 |
|----------|------|----------|
| `voice-range-test.js` | 音域テスト・警告アラート表示 | `calculateVoiceRange()`, `displayVoiceRangeResults()` |
| `trainingController.js` | 基音自動拡張 | `getAvailableNotes()`, `selectAllBaseNotesForMode()` |
