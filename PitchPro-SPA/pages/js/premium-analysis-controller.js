...
function updateTab3UI(plan) {
    ...
    plan.forEach((item, index) => {
        const priorityColors = {
            1: { bg: 'rgba(239, 68, 68, 0.1)', border: 'rgba(239, 68, 68, 0.3)', text: '#ef4444' },
            2: { bg: 'rgba(245, 158, 11, 0.1)', border: 'rgba(245, 158, 11, 0.3)', text: '#f59e0b' },
            3: { bg: 'rgba(16, 185, 129, 0.1)', border: 'rgba(16, 185, 129, 0.3)', text: '#10b981' }
        };
            ...
            <div class="glass-card" style="margin-bottom: 1.5rem;">
                ...
                <div style="background: rgba(255, 255, 255, 0.05); padding: 1rem; border-radius: 8px;">
                    <div class="flex items-center gap-2" style="margin-bottom: 0.75rem;">
                        ...
                        <h5 style="color: #fbbf24; font-weight: 600; margin: 0; font-size: 0.875rem;">練習方法</h5>
                    </div>
                    <ul style="color: #cbd5e1; font-size: 0.875rem; line-height: 1.6; margin: 0; padding-left: 1.5rem;">
                        ${item.exercises.map(ex => `<li style="margin-bottom: 0.5rem;">${ex}</li>`).join('')}
                    </ul>
                </div>
            </div>
        `;
