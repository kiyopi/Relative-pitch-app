...
| ランク | 最終スコア | Excellence割合 | Lucideアイコン | 表示色 | メッセージ |
|--------|-----------|--------------|---------------|--------|------------|
| **S級** | 95-100 | 80%以上 | `trophy` | ゴールド | 完璧！プロレベルの精度です！ |
| **A級** | 85-94 | 60%以上 | `award` | グリーン | 素晴らしい！とても正確です |
| **B級** | 75-84 | 40%以上 | `star` | ブルー | 良好！安定した音感です |
| **C級** | 65-74 | 20%以上 | `check-circle` | オレンジ | 合格！基礎は身についています |
| **D級** | 50-64 | - | `target` | イエロー | もう少し！練習を続けましょう |
| **E級** | 0-49 | - | `book-open` | グレー | 基礎から練習しましょう |

※ S級・A級は最終スコアとExcellence割合の両方を満たす必要があります
※ B級・C級はどちらか一方を満たせば認定されます
...
|--------|----------------|------|------------|--------|
| **S級** | `trophy` | 総合評価表示 | `icon-xl` | gold |
| **A級** | `award` | 総合評価表示 | `icon-xl` | green |
